...
# 等待时间 产生随机数
import time, random
#C:\Users\张献强\Desktop\kline-master\node_modules\chromedriver\lib\chromedriver\chromedriver.exe
# 滑块移动轨迹
...
def login():
    ...
    # 输入账号#mat-input-0
    #
    driver.find_element_by_xpath('//*[@id="mat-input-0"]').send_keys('poort')
    # 输入密码
    driver.find_element_by_xpath('//*[@id="mat-input-1"]').send_keys('110112119zxq')
    # 点击登录
    driver.find_element_by_xpath('//div/button/span[1]').click()
    # 等待2s使验证弹窗加载完成
    time.sleep(2)
    # 定位到圆球 mat-input-0
